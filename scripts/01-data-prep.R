...
# 4) Data exploration: mean demographic values by treatment assignment
# Using data_raw, the following vabiables:
# race: 1 = white
# gender4: 1 = male
# BGU_knowledge1 to BGU_knowledge6 for political knowledge
# BGU_Trumpapproval: 1 = strongly approve 5 = strongly disapprove
# CC21_330a ideology: 1 = very liberal 7 = very conservative
# pid3 party id: 1 = democrat 2 = republican 3 = independent
# faminc_new
# educ
